package com.prisar.dalim.data.autocomplete

import android.content.Context
import androidx.annotation.WorkerThread
import com.prisar.dalim.data.autocomplete.AutoCompleteService.AutoCompleteResult
import com.prisar.dalim.data.autocomplete.AutoCompleteService.InitModelResult
...
import com.prisar.dalim.util.splitToWords
import com.prisar.dalim.util.trimToMaxWordCount
...
class AutoCompleteServiceImpl(
     ...
     */
    override val inputConfiguration = AutoCompleteService.AutoCompleteInputConfiguration(
        // Minimum number of words to be taken from the end of the input text
        minWordCount = 5,
    ...
    override suspend fun getSuggestion(input: String, applyWindow: Boolean, windowSize: Int) = withContext(dispatcher) {
        ...
        if (languageChecker.containsBadLanguage(input)) {
            ...
            return@withContext AutoCompleteService.AutoCompleteResult.Error(AutoCompleteService.AutoCompleteServiceError.BAD_LANGUAGE)
        }
